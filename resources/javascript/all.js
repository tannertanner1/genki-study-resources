...
(function (window, document) {
  ...
  if (document.getElementById("announcement")) {
    window.GenkiAnn = {
      ...
      msg: [
        {
          date: "6/6/25",
          content:
            'Quartet Study Resources is now available! <a href="https://ko-fi.com/post/Quartet-Study-Resources-is-Now-Available-Y8Y61G3093" target="_blank">Click here</a> to learn more about this new Japanese practice website.',
        },

        {
          date: "5/22/25",
          content:
            'From today on, I will be streaming the development progress of Quartet Study Resources on Twitch each day to share the process of building these websites. <a href="https://ko-fi.com/post/About-Development-Streams-Z8Z61FDRV3" target="_blank">Click here</a> for more information, such as my schedule.',
        },

        {
          date: "5/13/25",
          content:
            'You can now choose what exercises you want to practice for the Random Exercise Button via the settings manager! <a href="https://ko-fi.com/post/New-Custom-Random-Exercise-Range-for-GenkiTobira-U6U41EXQ3G" target="_blank">Click here</a> to learn more about this new setting.',
        },

        {
          date: "5/9/25",
          content:
            'You can now change the interface language of the website to 日本語 via the settings manager! <a href="https://ko-fi.com/post/New-Language-Option-for-GenkiTobira-A0A41EQV3C" target="_blank">Click here</a> to learn more about this new setting.',
        },

        {
          date: "4/8/25",
          content:
            'The Genki <a href="https://ko-fi.com/post/The-Genki-Grammar-Index-is-now-Complete-U7U01D73DJ" target="_blank">Grammar Index</a> is now complete! If you notice any typos or have any suggestions, please don\'t hesitate to let us know on GitHub. Happy Studying!',
        },

        {
          date: "2/10/25",
          content:
            'You can now change the main theme color to the Genki II color scheme via the settings manager! <a href="https://ko-fi.com/post/New-Theme-Option-for-Genki-Study-Resources-L3L21ADWSN" target="_blank">Click here</a> to learn more about this new setting.',
        },

        {
          date: "1/15/25",
          content:
            'Happy New Year! With the new year, comes new projects! <a href="https://ko-fi.com/post/Plans-for-2025-C0C2192FBX" target="_blank">Click here</a> to learn about what I have planned for 2025.',
        },

        {
          date: "12/14/24",
          content:
            'I\'ve been slowly rolling out ads on my website recently. They\'re optional for this project, however, so please <a href="https://ko-fi.com/post/Statement-Regarding-Ads-V7V717GGS6" target="_blank">click here</a> to learn more about this update.',
        },

        {
          date: "10/26/24",
          content:
            '<a href="https://ko-fi.com/post/GenkiTobira-Recent-Updates-Future-Plans-Z8Z6158OWB" target="_blank">Click here</a> to learn about the recent updates made to the website as well as my future plans.',
        },

        {
          content:
            'Interested in learning Japanese? Check out <a href="' +
            getPaths() +
            'help/japanese-guide/">our guide</a> for more information on how to learn the language, as well as useful tools that you can utilize in your studies!',
        },

        {
          edition: "2nd",
          content:
            'Looking for more self-study resources? Visit the official <a href="http://genki.japantimes.co.jp/self_en">self-study room</a> for Genki or check out some of the resources in the <a href="https://github.com/SethClydesdale/genki-study-resources#resources-for-studying-japanese">readme</a> on GitHub.',
        },

        {
          edition: "3rd",
          content:
            'Looking for more self-study resources? Visit the official <a href="https://genki3.japantimes.co.jp/en/student/">self-study room</a> for Genki or check out some of the resources in the <a href="https://github.com/SethClydesdale/genki-study-resources#resources-for-studying-japanese">readme</a> on GitHub.',
        },

        {
          content:
            'Want to stay up to date on the latest changes made to Genki Study Resources? You can follow updates via <a href="https://github.com/SethClydesdale/genki-study-resources/commits/master">GitHub</a>, <a href="https://twitter.com/search?q=(%23GenkiStudyResources)%20(from%3Asethc1995)&src=typed_query&f=live">Twitter</a>, or <a href="https://ko-fi.com/sethc95/posts">Ko-fi</a>. Feel free to also contact us on <a href="https://github.com/SethClydesdale/genki-study-resources/discussions">the forum</a> if you have any questions or feedback.',
        },

        {
          content:
            'Have a question about the site? Check out the <a href="' +
            getPaths() +
            "help/\">FAQ</a>! If you can't find an answer to your question, feel free to contact us via <a href=\"https://github.com/SethClydesdale/genki-study-resources/issues\">GitHub's issues</a> and we'll try to answer your question in a timely manner.",
        },

        {
          content:
            'Find a bug or mistake on the site? Want to submit a suggestion or give us feedback? Check out the <a href="' +
            getPaths() +
            "report/\">report page</a> for more information. We'd love to hear from you!",
        },

        {
          content:
            "Don't have a network connection all the time? Genki Study Resources can be used offline as well! Head on over to the <a href=\"" +
            getPaths() +
            'download/">download page</a> to get the latest release.',
        },

        {
          content:
            'If you found this tool helpful for studying with Genki, please consider making <a href="' +
            getPaths() +
            'donate/">a donation</a> to help support my work. Thank you!',
        },
      ],
      ...
      next: function (n, manual) {
        ...
        // show new message
        GenkiAnn.msg[GenkiAnn.index].className = GenkiAnn.msg[
          GenkiAnn.index
        ].className.replace(" announce-hidden", "");
      ...
      init: function () {
        ...
        if (GenkiAnn.msg.length > 1) {
          ...
          // parse announcements
          for (
            var i = 0, j = GenkiAnn.msg.length, ann = "", first = true;
            i < j;
            i++
          ) {
            if (
              !GenkiAnn.msg[i].edition ||
              GenkiAnn.msg[i].edition.toLowerCase() == GenkiAnn.edition
            ) {
              ann +=
                '<div class="announcement' +
                (first ? "" : " announce-hidden") +
                '">' +
                (GenkiAnn.msg[i].date
                  ? '<span class="date">' + GenkiAnn.msg[i].date + "</span>"
                  : "") +
        ...
        if (window.location.protocol != "file:") {
          ...
          var cacheState = function (state) {
            ...
            displayLiveAnnouncement = function () {
              document.querySelector(
                ".announcement:not(.announce-hidden)",
              ).className += " announce-hidden";
              GenkiAnn.list.insertAdjacentHTML(
                "afterBegin",
                '<div class="announcement">' +
          ...
          if (
            storageOK &&
            localStorage.twitchLiveState &&
            localStorage.twitchLiveState_exp > +new Date() - 30 * 60 * 1000
          ) {
    ...
    if (month == 12 && day == 25) {
      GenkiAnn.msg.splice(0, 0, {
        content:
          "<ruby>今日<rt>きょう</rt></ruby>はクリスマスだよ。メリークリスマス！",
      });
      ...
      ann.insertAdjacentHTML(
        "beforeend",
        '<div id="holiday-deco" style="height:100px;width:100%;position:absolute;left:0;bottom:-70px;background-image:url(\'' +
          getPaths() +
          "resources/images/holiday/xmas.png" +
          "');background-size:auto 100%;pointer-events:none;\"></div>",
      );
    }
    ...
    // halloween
      ...
      GenkiAnn.msg.splice(0, 0, {
        content:
          "ハッピーハロウィン！お<ruby>菓子<rt>かし</rt></ruby>をくれないとイタズラしちゃうぞ！",
      });
      ...
      window._scrollSpider = {
        ...
        move: function () {
          _scrollSpider.spider.style.top =
          ...
          if (
            ...
            _scrollSpider.scroll = {
              ...
              by:
                (document.documentElement.scrollHeight -
                  document.documentElement.clientHeight) /
                100, // scroll by 1% of the total document height
              ...
              window: window.setInterval(function () {
                if (_scrollSpider.scroll.top > 0) {
                  _scrollSpider.scroll.body.scrollTop =
                    _scrollSpider.scroll.top -= _scrollSpider.scroll.by;
                  _scrollSpider.move();
                } else {
        ...
        init: function () {
          ...
          spider.innerHTML =
            '<div style="' +
            _scrollSpider.config.web +
            '"></div><img src="' +
            _scrollSpider.config.image +
            '" onclick="_scrollSpider.toTop();" style="cursor:pointer;" title="' +
            _scrollSpider.config.tooltip +
            '">';
          spider.style.position = "fixed";
          spider.style[
            /left|right/i.test(_scrollSpider.config.side)
              ? _scrollSpider.config.side
              : "right"
          ] = _scrollSpider.config.offset;
          spider.style.top = "0%";
    ...
    // new year's
      ...
      GenkiAnn.msg.splice(0, 0, {
        content:
          "<ruby>皆<rt>みな</rt></ruby>さん、あけましておめでとうございます！<ruby>今年<rt>ことし</rt></ruby>も<ruby>頑張<rt>がんば</rt></ruby>りましょう！",
      });
    }
  ...
  function attachSettingsHandler(settingsEl) {
    settingsEl.title =
      GenkiLang == "ja" ? "ウェブサイトの設定" : "Site Settings";
  ...
  if (storageOK) {
    ...
    var containerExists =
      document.getElementById("light-switch-container") &&
      existingCheckbox &&
      footer &&
      footer.contains(document.getElementById("light-switch-container"));

    if (containerExists && footer.contains(existingCheckbox)) {
      // Footer controls already in DOM (e.g. lessons-3rd index with minimal footer)
      ...
      container.innerHTML =
        '<label id="light-switch-label" for="light-switch-checkbox"><span class="en">Dark Mode</span><span class="ja">ダークモード</span> </label>';
  ...
  // show help link instead of dark mode when running in limited mode
    ...
    container.innerHTML =
      ...
      '"><strong><span class="en">Where is Dark Mode?</span><span class="ja">ダークモードはどこ？</span></strong></a>';
  ...
  document.addEventListener("keydown", function (e) {
    ...
    if (Genki.active.type == "multi" && e.altKey) {
      ...
      var opt = document.querySelector(
        "#quiz-q" + Genki.stats.solved + ' div[data-option="' + answer + '"]',
      );
