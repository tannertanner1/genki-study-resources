...
;(function (window, document) {
  ...
  window.GenkiModal = {
    ...
    open: function (o) {
      ...
      modal.innerHTML =
        '<div id="genki-modal-overlay"' +
        (o.zIndex == "low" ? ' style="z-index:1;"' : "") +
        "></div>" +
        '<div id="genki-modal-body" style="' +
        (o.zIndex == "low" ? "z-index:2;" : "") +
        (o.customSize ? "top:" + o.customSize.top + ";right:" + o.customSize.right + ";bottom:" + o.customSize.bottom + ";left:" + o.customSize.left + ";" : "") +
        '">' +
        '<h2 id="genki-modal-header">' +
        (o.title ? o.title : "Popup") +
        "</h2>" +
        '<div id="genki-modal-content">' +
        (o.content ? o.content : "") +
        "</div>" +
  ...
  window.CreateCustomInputs = function () {
    for (var input = document.querySelectorAll('input[type="checkbox"], input[type="radio"]'), i = 0, j = input.length, type; i < j; i++) {
      if (!/light-switch-checkbox|genki_input_hidden/g.test(input[i].outerHTML)) {
        // exclusions
  ...
  window.GenkiSettings = {
    manager: function () {
      ...
      GenkiModal.open({
        ...
        content:
          ...
          "</span>" +
          '<input id="font-size-range" type="range" min="100" max="500" value="' +
          fontSize +
          '" oninput="GenkiSettings.updateFontSize(this);" onchange="GenkiSettings.updateFontSize(this, true);"><span id="font-size-value">' +
          fontSize +
          "%</span>" +
          "</li>" +
          "<li>" +
          ...
          "</span>" +
          '<input id="page-width-range" type="range" min="100" max="500" value="' +
          pageWidth +
          '" oninput="GenkiSettings.updatePageWidth(this);" onchange="GenkiSettings.updatePageWidth(this, true);"><span id="page-width-value">' +
          pageWidth +
          "%</span>" +
          "</li>" +
          "<li>" +
          ...
          '<option value="en"' +
          (genkiLang == "en" ? " selected" : "") +
          ">English</option>" +
          '<option value="ja"' +
          (genkiLang == "ja" ? " selected" : "") +
          ">日本語</option>" +
          "</select>" +
          "</li>" +
          "<li>" +
          ...
          '<option value="genki1"' +
          (genkiTheme == "genki1" ? " selected" : "") +
          ">" +
          (GenkiLang == "ja" ? "げんき" : "Genki ") +
          "I</option>" +
          '<option value="genki2"' +
          (genkiTheme == "genki2" ? " selected" : "") +
          ">" +
          (GenkiLang == "ja" ? "げんき" : "Genki ") +
          "II</option>" +
          "</select>" +
          ...
          "</span>" +
          '<button id="settings-dark-mode" class="button' +
          (darkMode == "on" ? "" : " opt-off") +
          '" onclick="GenkiSettings.updateDarkMode(this);">' +
          (darkMode == "on" ? "ON" : "OFF") +
          "</button>" +
          "</li>" +
          (window.location.protocol == "file:"
            ...
            : "<li>" +
              ...
              '<button id="settings-dark-mode" class="button' +
              (adverts == "on" ? "" : " opt-off") +
              '" onclick="GenkiSettings.updateAdverts(this);">' +
              (adverts == "on" ? "ON" : "OFF") +
              "</button>" +
              "</li>") +
          "<li>" +
          ...
          "</span>" +
          '<textarea id="page-custom-css" oninput="GenkiSettings.updateCustomCSS(this, true);">' +
          customCSS +
          "</textarea>" +
          "</li>" +
          "</ul>" +
          ...
          "</span>" +
          '<button id="settings-furigana" class="button' +
          (furigana == "true" ? "" : " opt-off") +
          '" onclick="GenkiSettings.updateFurigana(this);">' +
          (furigana == "true" ? "ON" : "OFF") +
          "</button>" +
          "</li>" +
          "<li>" +
          '<span class="label">' +
          ...
          '<option value="false"' +
          (vocabHorizontal == "false" ? " selected" : "") +
          ">" +
          (GenkiLang == "ja" ? "垂直" : "Vertical") +
          "</option>" +
          '<option value="true"' +
          (vocabHorizontal == "true" ? " selected" : "") +
          ">" +
          (GenkiLang == "ja" ? "水平" : "Horizontal") +
          "</option>" +
          "</select>" +
          "</li>" +
          "<li>" +
          ...
          (feedbackMode == "classic" ? " selected" : "") +
          ">" +
          (GenkiLang == "ja" ? "クラシック" : "Classic") +
          "</option>" +
          '<option value="instant"' +
          (feedbackMode == "instant" ? " selected" : "") +
          ">" +
          (GenkiLang == "ja" ? "インスタント" : "Instant") +
          "</option>" +
          "</select>" +
          "</li>" +
          "<li>" +
          ...
          "</span>" +
          '<button id="settings-vocab-spoiler" class="button' +
          (spoilerMode == "true" ? "" : " opt-off") +
          '" onclick="GenkiSettings.updateSpoilerMode(this);">' +
          (spoilerMode == "true" ? "ON" : "OFF") +
          "</button>" +
          "</li>" +
          "<li>" +
          '<span class="label">' +
          ...
          '<option value="all"' +
          (randomExercise == "all" ? " selected" : "") +
          ">" +
          (GenkiLang == "ja" ? "すべての課" : "All Lessons") +
          "</option>" +
          '<option value="lesson"' +
          (randomExercise == "lesson" ? " selected" : "") +
          ">" +
          (GenkiLang == "ja" ? "今の課" : "Current Lesson") +
          "</option>" +
          '<option value="completed"' +
          (randomExercise == "completed" ? " selected" : "") +
          ">" +
          (GenkiLang == "ja" ? "終えた練習問題のみ" : "Completed Exercises") +
          "</option>" +
          '<option value="custom"' +
          (randomExercise == "custom" ? " selected" : "") +
          ">" +
          (GenkiLang == "ja" ? "カスタム" : "Custom") +
          "</option>" +
          "</select>" +
          '<button id="random-exercise-list" class="button" style="display:' +
          (randomExercise == "custom" ? "" : "none") +
          ';" onclick="GenkiSettings.randomExerciseList();"><i class="fa">&#xf03a;</i><span class="en">Random Exercise List</span><span class="ja">ランダム練習リスト</span></button>' +
          "</li>" +
          "<li>" +
          '<span class="label">' +
          ...
          "</span>" +
          '<button id="settings-skip-ex-type" class="button' +
          (skipExType == "true" ? "" : " opt-off") +
          '" onclick="GenkiSettings.updateSkipExType(this);">' +
          (skipExType == "true" ? "ON" : "OFF") +
          "</button>" +
          "</li>" +
          "<li>" +
          '<span class="label">' +
          ...
          "</span>" +
          '<button id="settings-jisho-lookup" class="button' +
          (jishoLookUp == "true" ? "" : " opt-off") +
          '" onclick="GenkiSettings.updateJishoLookUp(this);">' +
          (jishoLookUp == "true" ? "ON" : "OFF") +
          "</button>" +
          "</li>" +
          "<li>" +
          '<span class="label">' +
          ...
          "</span>" +
          '<button id="settings-stroke-order" class="button' +
          (strokeOrder == "true" ? "" : " opt-off") +
          '" onclick="GenkiSettings.updateStrokeOrder(this);">' +
          (strokeOrder == "true" ? "ON" : "OFF") +
          "</button>" +
          "</li>" +
          "<li>" +
          '<span class="label">' +
          ...
          "</span>" +
          '<button id="settings-tracing-guide" class="button' +
          (tracingGuide == "true" ? "" : " opt-off") +
          '" onclick="GenkiSettings.updateTracingGuide(this);">' +
          (tracingGuide == "true" ? "ON" : "OFF") +
          "</button>" +
          "</li>" +
          "<li>" +
          '<span class="label">' +
          ...
          "</span>" +
          '<button id="settings-timer-auto-pause" class="button' +
          (timerAutoPause == "true" ? "" : " opt-off") +
          '" onclick="GenkiSettings.updateTimerAutoPause(this);">' +
          (timerAutoPause == "true" ? "ON" : "OFF") +
          "</button>" +
          "</li>" +
          "<li>" +
          '<span class="label">' +
          ...
          "</span>" +
          '<button id="settings-data-backup-reminder" class="button' +
          (dataBackupReminder == "true" ? "" : " opt-off") +
          '" onclick="GenkiSettings.updateDataBackupReminder(this);">' +
          (dataBackupReminder == "true" ? "ON" : "OFF") +
          "</button>" +
          "</li>" +
          "<li>" +
          '<span class="label">' +
          ...
          "</span>" +
          '<a id="settings-save-exercise-data" class="button" download="Genki Exercise Score Data.txt" href="data:text/plain;charset=utf-8,' +
    ...
    revert: function () {
      GenkiModal.open({
        ...
        closeButtonText: '<span class="en">Return to Settings</span><span class="ja">設定に戻る</span>',
        callback: function () {
          var settings = ["genkiFontSize", "genkiPageWidth", "genkiLang", "genkiTheme", "darkMode", "adverts", "genkiCustomCSS", "furiganaVisible", "spoilerMode", "vocabHorizontal", "feedbackMode", "genkiRandomExercise", "genkiSkipExType", "genkiJishoLookUp", "strokeOrderVisible", "tracingGuideVisible", "timerAutoPause", "dataBackupReminder"],
            i = 0,
            j = settings.length
    ...
    viewExerciseData: function () {
      GenkiModal.open({
        ...
        content: '<div class="center">' + '<textarea id="copy-data" onfocus="this.select();" style="width:80%;height:150px;" readonly>' + (storageOK && localStorage.Results ? JSON.stringify(JSON.parse(localStorage.Results), "", "  ") : GenkiLang == "ja" ? "データが見つかりませんでした。(ᓀ‸ᓂ)" : "No data found. (ᓀ‸ᓂ)") + "</textarea><br>" + '<button class="button" onclick="CopyText(document.getElementById(\'copy-data\').value, this);"><i class="fa">&#xf0c5;</i><span class="en">Copy</span><span class="ja">コピーする</span></button>' + "</div>",
    ...
    updateFontSize: function (caller, updateCSS) {
      ...
      if (updateCSS) {
        var css =
          "/*FONT-SIZE-START*/" +
          // font size
          "footer li:before { font-size:" +
          6 * n +
          "px }" +
          ".kana-quiz.quiz-over [data-mistakes]:after { font-size:" +
          8 * n +
          "px }" +
          ".quiz-over .vocab-horizontal [data-mistakes]:after, .verb-quiz.quiz-over [data-mistakes]:after { font-size:" +
          10 * n +
          "px }" +
          ".define, #announcement .announcement .date, #quick-search-results li[data-lesson]:before, .writing-quiz .quiz-item:before, .helper-present #question-list .quiz-item:before, .furigana, .inline-furi i, ruby rt, .secondary-answer, .def-ja.def-furi i { font-size:" +
          11 * n +
          "px }" +
          "#exercise-title:after, .title[data-page]:after, #exercise-list li a[data-page]:hover:after, #exercise-list li a[data-page]:focus:after, .leg-desc, .sectionNumber3rd { font-size:" +
          12 * n +
          "px }" +
          ".kanji-readings.drag-quiz .vocab-horizontal #question-list .quiz-answer-zone .quiz-item, .kanji-meanings.drag-quiz .vocab-horizontal #question-list .quiz-answer-zone .quiz-item, .image-list span i, .checkbox-label { font-size:" +
          13 * n +
          "px }" +
          'body, p, input[type="text"], input[type="number"], textarea, select, #announcement .announcement, #link-list span, .workbook-title, .normal-block, .quiz-over [data-mistakes]:after, #wrongAnswer:before, .writing-quiz .quiz-item, input.writing-zone-input, .quiz-multi-question, .quiz-multi-answer, .text-block, .fill-quiz .writing-zone-input, .problem-hint, .problem-answer, .definition, .lesson-summary, #exercise-list .sub-lesson-title, .button:not(.play-button), a.button, #study-tool-settings li { font-size:' +
          14 * n +
          "px }" +
          "#exercise-list .lesson-title, #genki-modal-content, .table.grammar-table td { font-size:" +
          15 * n +
          "px }" +
          "#link-list i, #exercise:before, .loading:before, .sub-lesson-title, .workbook-title, .title-desc, #exercise .text-passage, #complete-banner, #downloadCode:before, .definition-count, .multi-vocab rt, .table-head { font-size:" +
          16 * n +
          "px }" +
          ".group-selectors .select-all:before, .group-selectors .deselect-all:before { font-size:" +
          17 * n +
          "px }" +
          ".button .fa, .more-exercises a:after, .more-exercises a:before, #link-github i, #link-help i, .title-med, .sub-title, #exercise-list .main-title, .quiz-multi-answer:before, #genki-site-settings, .dictionary-index li, #quick-jisho-title { font-size:" +
          18 * n +
          "px }" +
          "#quick-actions h2, .lesson-title, .vocab-key:before { font-size:" +
          20 * n +
          "px }" +
          ".section-title, #exercise-title, #break-timer, #announcement .fa, .multi-vocab-sentence { font-size:" +
          24 * n +
          "px }" +
          ".kanji-readings.drag-quiz #question-list .quiz-item, .kanji-meanings.drag-quiz #question-list .quiz-item { font-size:" +
          26 * n +
          "px }" +
          ".title { font-size:" +
          28 * n +
          "px }" +
          ".multi-vocab { font-size:" +
          32 * n +
          "px }" +
          // width
          ".slim-ruby ruby { width:" +
          10 * n +
          "px }" +
          ".result-label { width:" +
          150 * n +
          "px }" +
          ".kana-quiz .quiz-answer-zone:empty, .kana-quiz .quiz-item { width:" +
          35 * n +
          "px }" +
          // height
          ".problem-hint, .problem-answer { height:" +
          20 * n +
          "px }" +
          "#quiz-progress, #quiz-progress-bar { height:" +
          25 * n +
          "px }" +
          "#genki-site-settings { height:" +
          26 * n +
          "px }" +
          ".kanji-meanings.drag-quiz .vocab-horizontal #question-list .quiz-answer-zone .quiz-item, .drag-quiz .quiz-item, .drag-quiz .quiz-answer-zone { height:" +
          28 * n +
          "px }" +
          ".vocab-key:before, .kana-quiz .quiz-answer-zone:empty, .kana-quiz .quiz-item { height:" +
          30 * n +
          "px }" +
          "#genki-modal-buttons, #genki-modal-header { height:" +
          40 * n +
          "px }" +
          ".kanji-meanings.drag-quiz .quiz-answer-zone, .kanji-meanings.drag-quiz #question-list .quiz-item, .kanji-meanings.drag-quiz #question-list .quiz-item, .kanji-meanings.drag-quiz .quiz-answer-zone, .kanji-readings.drag-quiz .quiz-answer-zone, .kanji-readings.drag-quiz .quiz-item { height:" +
          48 * n +
          "px }" +
          "#announcement { height:" +
          105 * n +
          ...
          70 * n +
          "px }" +
          ".multi-vocab { min-height:" +
          64 * n +
          "px }" +
          // line-height
          ".secondary-answer { line-height:" +
          10 * n +
          "px; }" +
          "#exercise-list li a[data-page]:focus:after, #exercise-list li a[data-page]:hover:after { line-height:" +
          12 * n +
          "px; }" +
          ".writing-quiz .quiz-item:before, .helper-present #question-list .quiz-item:before { line-height:" +
          15 * n +
          "px; }" +
          ".kanji-readings.drag-quiz .vocab-horizontal #question-list .quiz-answer-zone .quiz-item, .kanji-meanings.drag-quiz .vocab-horizontal #question-list .quiz-answer-zone .quiz-item, .drag-quiz .quiz-item, .drag-quiz .quiz-answer-zone, .problem-hint, .problem-answer { line-height:" +
          20 * n +
          "px; }" +
          ".kana-quiz .quiz-answer-zone:empty, .kana-quiz .quiz-item { line-height:" +
          22 * n +
          "px; }" +
          "#genki-site-settings, #quiz-progress-text { line-height:" +
          26 * n +
          "px; }" +
          "#quick-jisho-title { line-height:" +
          32 * n +
          "px; }" +
          ".vocab-key:before { line-height:" +
          34 * n +
          "px; }" +
          "#genki-modal-buttons, #genki-modal-header { line-height:" +
          40 * n +
          "px; }" +
          ".kanji-readings.drag-quiz #question-list .quiz-item, .kanji-meanings.drag-quiz #question-list .quiz-item { line-height:" +
          44 * n +
          "px; }" +
          // padding
          ".vocab-key { padding-top:" +
          30 * n +
          "px; }" +
          // margin
          ".writing-quiz .helper-present #question-list .quiz-item[data-helper] { margin-bottom:" +
          3 * n +
          "px; }" +
          ".quiz-multi-answer.next-question:before { margin-top:-" +
          9 * n +
          "px; }" +
          ".quiz-multi-answer:before { margin-top:-" +
          10 * n +
          "px; }" +
          ".writing-quiz .quiz-answer-row.furi-row { margin-bottom:" +
          12 * n +
          "px; }" +
          ".def-ja.def-furi { margin-bottom:" +
          15 * n +
          "px; }" +
          ".vocab-horizontal.helper-present #question-list .quiz-item, .helper-present #question-list .quiz-item[data-helper], .helper-present #drop-list .quiz-answer-zone.helper-answer { margin-bottom:" +
          18 * n +
          "px; }" +
          ".problem-hint, .problem-answer { margin-bottom:-" +
          20 * n +
          "px; }" +
          ".fill-quiz .small-margin .block, .fill-quiz .small-margin .problem { margin-bottom:" +
          25 * n +
          "px; }" +
          ".question-block { margin:" +
          30 * n +
          "px 0; }" +
          ".fill-quiz .big-margin, .fill-quiz .example-problem, .fill-quiz .problem, .fill-quiz.quiz-over td .writing-zone { margin-bottom:" +
          40 * n +
          "px; }" +
          // positioning
          ".kana-quiz .answer-correct .quiz-item:before { top:-" +
          5 * n +
          "px; right:-" +
          8 * n +
          "px; }" +
          ".writing-quiz .quiz-item:before, .helper-present #question-list .quiz-item:before, .def-ja.def-furi i { bottom:-" +
          15 * n +
          "px }" +
          ".question-block:after { top:-" +
          20 * n +
          "px }" +
          ".quiz-multi-answer:before { left:-" +
          25 * n +
          "px }" +
          "#genki-modal-content { top:" +
          40 * n +
          "px }" +
          "#genki-modal-content { bottom:" +
          40 * n +
          "px }" +
          "#wrongAnswer:before { right:-" +
          70 * n +
          "px }" +
          ".quiz-over [data-mistakes]:after { right:-" +
          85 * n +
          "px }" +
          // bottom borders
          ".fill-quiz .writing-zone-input, .section-title, .lesson-title, #link-list a { border-bottom-width:" +
          2 * n +
          "px; }" +
          // modal position
          "#genki-modal-body { top:" +
          10 / n +
          "%; left:" +
          25 / n +
          "%; right:" +
          ...
          301 * n +
          "px; }" +
          "#toggle-exercises.list-open { left:" +
          (300 * n - 30) +
          "px; }" +
          // quick jisho
          "#quick-jisho-window { height:" +
          300 * n +
          "px; width:" +
          500 * n +
          "px; }" +
          "#quick-jisho-window.quick-jisho-hidden { bottom:-" +
          310 * n +
          "px; }" +
          "#quick-jisho-results { height:" +
          219 * n +
          "px; }" +
          "#quick-jisho-search { height:" +
          35 * n +
          "px; }" +
          ".quick-jisho-row, #quick-jisho-results { padding:" +
          3 * n +
          "px; }" +
          "#quick-jisho-selector { border-radius:" +
          15 * n +
          "px; }" +
          // quick nav sub-section buttons
          "#quick-nav-list a.sub-section-button { font-size:" +
          11 * n +
          "px; height:" +
          18 * n +
          "px; width:" +
          ...
          22 * n +
          "px; }" +
          "#quick-nav-list li:before { height:" +
          6 * n +
          "px; width:" +
          6 * n +
          "px; left:-" +
          16 * n +
          "px; }" +
          "#quick-nav-list li ul li:before { height:" +
          4 * n +
          "px; width:" +
          4 * n +
          "px; }" +
          // play buttons
          ".button.play-button { height:" +
          25 * n +
          "px; width:" +
          25 * n +
          "px; }" +
          ".button.play-button i { font-size:" +
          14 * n +
          "px; }" +
          // example
          ".example-problem:before { font-size:" +
          12 * n +
          "px; line-height:" +
          12 * n +
          "px; padding:" +
          ...
          5 * n +
          "px; }" +
          ".example-problem.inline-columns { padding-left:" +
          62 * n +
          "px; }" +
          ...
          ".sectionNumber3rd, .section-number { width:" +
          22 * n +
          "px; height:" +
          22 * n +
          "px; line-height:" +
          ...
          "#announcement .announce-controls { margin-top:-" +
          15 * n +
          "px; height:" +
          30 * n +
          "px; width:" +
          20 * n +
          "px; }" +
          "#announcement .announce-controls i.fa { font-size:" +
          18 * n +
          "px; line-height:" +
          26 * n +
          "px; }" +
          "#announcement .announce-controls.button-left { left:-" +
          20 * n +
          "px; }" +
          "#announcement .announce-controls.button-right { right:-" +
          20 * n +
          "px; }" +
          "#announce-list { margin:0 " +
          20 * n +
          "px; }" +
          // overrides
        ...
        if (caller) {
          // if caller is not present, CSS was updated on page load, thus the following elements are null
    ...
    updatePageWidth: function (caller, updateCSS) {
      ...
      // update the CSS
      if (updateCSS) {
        var css = "/*PAGE-WIDTH-START*/" + ".content-block, #announce-inner { max-width:" + 1000 * n + "px }" + "/*PAGE-WIDTH-END*/"
      ...
      var parseExercises = function () {
        ...
        for (var list = "", selected = "", i = 0, j = GenkiExercises.length, data, checked, item; i < j; i++) {
          ...
          if (!/study-tools|appendix/i.test(data[0])) {
            item =
              '<div data-lesson="' +
              data[0].replace(/.*?lesson-(\d+).*/, "L$1") +
              '" data-path="' +
              data[0] +
              '" data-name="' +
              data[1] +
              '">' +
              '<input class="def-selector genki_input_hidden" type="checkbox" onchange="GenkiSettings.updateRandomList(this, \'' +
              GenkiExercises[i] +
              "');\"" +
              (GenkiRandomList.indexOf(GenkiExercises[i]) != -1 ? " checked" : "") +
              ">" +
  ...
  window.preLoadFonts = function () {
    ...
    for (var a = arguments, i = 0, j = arguments.length, styles = "", fonts = "", font; i < j; i++) {
      font = a[i].replace(/\..*?$/, "")
      fonts += font + (i == j - 1 ? "" : ", ")
      styles += "@font-face {" + 'font-family:"' + font + '";' + "src:url(" + getPaths() + "resources/fonts/" + a[i] + ') format("' + (/otf/.test(a[i]) ? "opentype" : /ttf/ ? "truetype" : "") + '");' + "}\n"
    }
